import wget
wget.download("https://raw.githubusercontent.com/datasets/s-and-p-500-companies/master/data/constituents.csv")

# time python dividend.py
...
def get_div(csvline):
    ...
    try:
        ...
        pos = req.text.find("Dividend Yield")
        co = []
        co.append(company[0])
